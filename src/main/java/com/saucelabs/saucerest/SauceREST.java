 ...
 * href="https://docs.saucelabs.com/reference/rest-api">https://docs.saucelabs.com/reference/rest-api</a>.
 *
 * @author Ross Rowe
 */
public class SauceREST implements Serializable {
  ...
  private static final long HTTP_READ_TIMEOUT_SECONDS =
      TimeUnit.SECONDS.toMillis(
          System.getenv("SAUCE_HTTP_READ_TIMEOUT_SECONDS") != null
              ? Integer.parseInt(System.getenv("SAUCE_HTTP_READ_TIMEOUT_SECONDS"))
              : 10);
  /** 10 seconds in milliseconds. */
  ...
  /**
   * Constructs a new instance of the SauceREST class, matching the datacenter string to datacenter
   * object
   *
   * @param username The username to use when performing HTTP requests to the Sauce REST API
   * @param accessKey The access key to use when performing HTTP requests to the Sauce REST API
  ...
  public String doJSONPOST(URL url, JSONObject body) throws SauceException {
    ...
    try {
      ...
      try {
        ...
        logger.log(
            Level.SEVERE, "Error POSTing to " + url.toString() + " and getting status code: ", e);
      }
   ...
   *
   * <p>Jobs are only available for jobs which finished without a Sauce side error, and for which
   * the 'recordVideo' capability is not set to false.
   *
   * <p>If an IOException is encountered during operation, this method will fail _silently_. Prefer
   * {@link #downloadVideoOrThrow(String, String)}
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
  ...
  /**
   * TODO: 2020-02-27 I think this should be called "downloadVideo" and "attemptVideoDownload"
   * should be the silent failure method - Dylan Downloads the video for a Sauce Job to the
   * filesystem. The file will be stored in a directory specified by the <code>location</code>
   * field.
   *
   * <p>Jobs are only available for jobs which finished without a Sauce side error, and for which
   * the 'recordVideo' capability is not set to false.
   ...
   * @throws com.saucelabs.saucerest.SauceException.NotAuthorized if credentials are wrong or
   *     missing
   * @throws IOException if something else goes wrong during asset retrieval
   */
  public void downloadVideoOrThrow(String jobId, String location)
      throws SauceException.NotAuthorized, IOException {
    URL restEndpoint = this.buildURL(username + "/jobs/" + jobId + "/assets/video.mp4");
    saveFileOrThrowException(
        jobId, location, getDefaultFileName(jobId, restEndpoint), restEndpoint);
  }

  /**
   * TODO: 27/2/20 I think this should be called "downloadVideo" and "attemptVideoDownload" should
   * be the silent failure method - Dylan Downloads the video for a Sauce Job to the filesystem. The
   * file will be stored in a directory specified by the <code>location</code> field.
   *
   * <p>Jobs are only available for jobs which finished without a Sauce side error, and for which
   * the 'recordVideo' capability is not set to false.
   *
   ...
   * @throws IOException if something else goes wrong during asset retrieval
   */
  public void downloadVideoOrThrow(String jobId, String location, String fileName)
      throws SauceException.NotAuthorized, IOException {
    URL restEndpoint = this.buildURL(username + "/jobs/" + jobId + "/assets/video.mp4");
   ...
   *
   * <p>Will probably eat your memory.
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
  ...
  /**
   * TODO: 2020-02-27 I think this should be called "attemptLogDownload" - Dylan Downloads the log
   * file for a Sauce Job to the filesystem. The file will be stored in a directory specified by the
   * <code>location</code> field.
   *
   * <p>If an IOException is encountered during operation, this method will fail _silently_. Prefer
   * {@link #downloadLogOrThrow(String, String)}
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
   * @param location represents the base directory where the video should be downloaded to
  ...
  /**
   * TODO: 27/2/20 I think this should be called "attemptLogDownload" - Dylan Downloads the log file
   * for a Sauce Job to the filesystem. The file will be stored in a directory specified by the
   * <code>location</code> field.
   *
   * <p>If an IOException is encountered during operation, this method will fail _silently_. Prefer
   * {@link #downloadLogOrThrow(String, String)}
  ...
  /**
   * TODO: 2020-02-27 I think this should be called "downloadLog" and "attemptLogDownload" should be
   * the silent failure method - Dylan Downloads the log file for a Sauce Job to the filesystem. The
   * file will be stored in a directory specified by the <code>location</code> field.
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
   * @param location represents the base directory where the video should be downloaded to
   ...
   * @throws IOException if something else goes wrong during asset retrieval
   */
  public void downloadLogOrThrow(String jobId, String location)
      throws SauceException.NotAuthorized, IOException {
    URL restEndpoint = this.buildURL(username + "/jobs/" + jobId + "/assets/selenium-server.log");
    saveFileOrThrowException(
        jobId, location, getDefaultFileName(jobId, restEndpoint), restEndpoint);
  ...
  /**
   * TODO: 27/2/20 I think this should be called "downloadLog" and "attemptLogDownload" should be
   * the silent failure method - Dylan Downloads the log file for a Sauce Job to the filesystem. The
   * file will be stored in a directory specified by the <code>location</code> field.
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
   ...
   * @throws IOException if something else goes wrong during asset retrieval
   */
  public void downloadLogOrThrow(String jobId, String location, String fileName)
      throws SauceException.NotAuthorized, IOException {
    URL restEndpoint = this.buildURL(username + "/jobs/" + jobId + "/assets/selenium-server.log");
    saveFileOrThrowException(jobId, location, fileName, restEndpoint);
  }
  ...
  /**
   * TODO: 2020-02-27 I think this should be renamed "attemptHARDownload" - Dylan Downloads the HAR
   * file for a Sauce Job to the filesystem. The file will be stored in a directory specified by the
   * <code>location</code> field.
   *
   * <p>This will only work for jobs which support Extended Debugging, which were started with the
   * 'extendedDebugging' capability set to true.
   *
   * <p>If an IOException is encountered during operation, this method will fail _silently_. Prefer
   * {@link #downloadHAROrThrow(String, String)}
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
  ...
  /**
   * TODO: 27/2/20 I think this should be renamed "attemptHARDownload" - Dylan Downloads the HAR
   * file for a Sauce Job to the filesystem. The file will be stored in a directory specified by the
   * <code>location</code> field.
   *
   * <p>This will only work for jobs which support Extended Debugging, which were started with the
  ...
  /**
   * TODO: 2020-02-27 I think this should be called "downloadHAR" and attemptHARDownload should be
   * the silent failure method - Dylan Downloads the HAR file for a Sauce Job to the filesystem. The
   * file will be stored in a directory specified by the <code>location</code> field.
   *
   * <p>This will only work for jobs which support Extended Debugging, which were started with the
   * 'extendedDebugging' capability set to true.
   ...
   * @throws IOException if something else goes wrong during asset retrieval
   */
  public void downloadHAROrThrow(String jobId, String location)
      throws SauceException.NotAuthorized, IOException {
    URL restEndpoint = this.buildEDSURL(jobId + "/network.har");
    saveFileOrThrowException(
        jobId, location, getDefaultFileName(jobId, restEndpoint), restEndpoint);
  ...
  /**
   * TODO: 27/2/20 I think this should be called "downloadHAR" and attemptHARDownload should be the
   * silent failure method - Dylan Downloads the HAR file for a Sauce Job to the filesystem. The
   * file will be stored in a directory specified by the <code>location</code> field.
   *
   * <p>This will only work for jobs which support Extended Debugging, which were started with the
   * 'extendedDebugging' capability set to true.
   ...
   * @throws IOException if something else goes wrong during asset retrieval
   */
  public void downloadHAROrThrow(String jobId, String location, String fileName)
      throws SauceException.NotAuthorized, IOException {
    URL restEndpoint = this.buildEDSURL(jobId + "/network.har");
    saveFileOrThrowException(jobId, location, fileName, restEndpoint);
  }
   ...
   *
   * <p>Pass this JSONTokener to a JSONObject when you wish to read JSON. The stream will be read as
  ...
  public String retrieveResults(URL restEndpoint) {
    ...
    try {
      ...
      logger.log(
          Level.SEVERE,
          "Received a SocketTimeoutException when invoking Sauce REST API, check"
              + " status.saucelabs.com for network outages",
          e);
  ...
  private BufferedInputStream downloadFileData(String jobId, URL restEndpoint)
      throws SauceException.NotAuthorized, IOException {
    ...
    switch (responseCode) {
      ...
      case 401:
        ...
        if (!errorReasons.isEmpty()) {
          errorReasons =
              (String.join(System.lineSeparator(), errorReasons, ErrorExplainers.missingCreds()));
        } else {
   ...
   *
   * <p>If an IOException is thrown during this process, this method will fail _silently_ (although
   * it will record the error at Level.WARNING. Use {@link #saveFileOrThrowException(String, String,
   * String, URL)} to fail with an exception.
   *
   * @param jobId the Sauce Job id
  ...
  private void saveFileOrThrowException(
      String jobId, String location, String fileName, URL restEndpoint)
      throws SauceException.NotAuthorized, IOException {
  ...
  public HttpURLConnection openConnection(URL url) throws IOException {
    ...
    if ("true".equals(System.getenv("USE_PROXY"))) {
      logger.log(
          Level.SEVERE,
          "Using proxy: " + System.getenv("http.proxyHost") + System.getenv("http.proxyPort"));

      Proxy proxy =
          new Proxy(
              Proxy.Type.HTTP,
              new InetSocketAddress(
                  System.getenv("http.proxyHost"),
   ...
   *     <p>Uploads a file to Sauce storage.
   */
  @Deprecated
   ...
   * @throws IOException can be thrown when server returns an error (tcp or http status not in the
   *     200 range)
   * @deprecated use {@link #uploadFile(InputStream, String, boolean)}. Uploads a file to Sauce
   *     storage.
   */
  @Deprecated
  ...
  public String uploadFile(InputStream is, String fileName, boolean overwrite) throws IOException {
    try {
      URL restEndpoint =
          buildURL("storage/" + username + "/" + fileName + "?overwrite=" + overwrite);
      ...
      if (sauceUploadResponse.has("error")) {
        throw new UnexpectedException(
            "Failed to upload to sauce-storage: " + sauceUploadResponse.getString("error"));
      }
   ...
   * (see <a
   * href="http://saucelabs.com/docs/integration#public-job-links">http://saucelabs.com/docs/integration#public-job-links</a>).
   *
   * @param jobId the Sauce Job Id, typically equal to the Selenium/WebDriver sessionId
   ...
   * browser platforms currently supported on Sauce Labs. (see <a
   * href="https://docs.saucelabs.com/reference/rest-api/#get-supported-platforms">https://docs.saucelabs.com/reference/rest-api/#get-supported-platforms</a>).
   *
  ...
  public String getBuildFullJobs(String build, int limit) {
    URL restEndpoint =
        buildURL(
            username + "/build/" + build + "/jobs?full=1" + (limit == 0 ? "" : "&limit=" + limit));
    return retrieveResults(restEndpoint);
  }
  ...
  public String getBuild(String build) {
    URL restEndpoint =
        buildURL(
            username
                + "/builds/"
                + build); // yes, this goes to builds instead of build like the above
    return retrieveResults(restEndpoint);
  }
